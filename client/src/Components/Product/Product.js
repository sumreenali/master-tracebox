            ...
            <div>
             ...
             <Table hover bordered responsive>
                ...
                <tbody>
                    ...
                    {product.map(({_id, name , image , description, price, quantity, date , status }) => (
                         <tr key={_id} stlye={{...styles, opacity:this.state.opacity}}>
                        {/* <tr key={id}> */}
                            ...
                            <td align="center">
                                <ButtonGroup size="md">
                                    ...
                                    onClick={() =>this.handleRemove(_id)}>Delete</Button>
                                </ButtonGroup>
                            </td>
                        </tr>
